...
# .items(): Возвращает все ключи в словаре и связанные c ними значения в виде последовательности кортежей.
items = my_dict.items()
print(items)
# dict_items([('a', 1), ('b', 2)])  
...
'''
# Этот тип операции также можно выполнить путем добавления условия if во
# включение в словарь. Условие if действует как фильтр, позволяя выбирать
# те или иные элементы из входной по­ следовательности.
# Вот общий формат:
